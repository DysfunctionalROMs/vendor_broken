...
# Set all versions
BROKEN_VERSION := Broken-$(BROKEN_VERSION_MAJOR)-$(BROKEN_BUILD)-$(BROKEN_VERSION_MINOR).$(PRODUCT_VERSION_MAINTENANCE).$(PLATFORM_VERSION_CODENAME)$(BROKEN_POSTFIX)
BROKEN_MOD_VERSION := Broken-$(BROKEN_VERSION_MAJOR)-$(BROKEN_BUILD)-$(BROKEN_VERSION_MINOR).$(PRODUCT_VERSION_MAINTENANCE).$(PLATFORM_VERSION_CODENAME)$(BROKEN_POSTFIX)
