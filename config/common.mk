...
# Set all versions
BROKEN_VERSION := Broken-$(PRODUCT_VERSION_MAINTENANCE)-$(BROKEN_BUILD)-$(BROKEN_VERSION_MAJOR)-$(BROKEN_VERSION_MINOR).$(PLATFORM_VERSION_CODENAME)$(BROKEN_POSTFIX)
BROKEN_MOD_VERSION := Broken-$(PRODUCT_VERSION_MAINTENANCE)-$(BROKEN_BUILD)-$(BROKEN_VERSION_MAJOR)-$(BROKEN_VERSION_MINOR).$(PLATFORM_VERSION_CODENAME)$(BROKEN_POSTFIX)
