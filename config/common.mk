...
ifeq ($(TESTING),TRUE)
PLATFORM_VERSION_CODENAME := TESTING
else
...
# Set all versions
BROKEN_VERSION := Broken-$(BROKEN_VERSION_MAJOR)-$(BROKEN_BUILD)-$(PRODUCT_VERSION_MAINTENANCE)-$(PLATFORM_VERSION_CODENAME)$(BROKEN_POSTFIX)
BROKEN_MOD_VERSION := Broken-$(BROKEN_VERSION_MAJOR)-$(BROKEN_BUILD)-$(PRODUCT_VERSION_MAINTENANCE)-$(PLATFORM_VERSION_CODENAME)$(BROKEN_POSTFIX)
