...
# Set all versions
BROKEN_VERSION := Broken-$(BROKEN_VERSION_MAJOR)-$(BROKEN_BUILD)-$(PRODUCT_VERSION_MAINTENANCE)-$(BROKEN_VERSION_MINOR).$(PLATFORM_VERSION_CODENAME)$(BROKEN_POSTFIX)
BROKEN_MOD_VERSION := Broken-$(BROKEN_VERSION_MAJOR)-$(BROKEN_BUILD)-$(PRODUCT_VERSION_MAINTENANCE)-$(BROKEN_VERSION_MINOR).$(PLATFORM_VERSION_CODENAME)$(BROKEN_POSTFIX)
