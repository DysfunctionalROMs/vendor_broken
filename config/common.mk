...
BROKEN_MOD_VERSION := Broken-$(BROKEN_BUILD)-$(BROKEN_VERSION_MAJOR).$(BROKEN_VERSION_MINOR).$(PRODUCT_VERSION_MAINTENANCE).$(PLATFORM_VERSION_CODENAME)-$(BROKEN_BUILD_TYPE)$(BROKEN_POSTFIX)
